...
class AreaClosedGraph extends React.Component {
  constructor(props){
    super(props)
  ...
  render(){
    ...
    console.log(x)
    console.log(y)
    const config = {stiffness :170,damping:16}
    return(
        ...
        <svg style={{ width:'100%', height:height }} >
            ...
            <Group top={margin.top-20} left={margin.left+40}>
                ...
                <AxisBottom
                  ...
                  <AreaClosed 
                    data={dataSet}
                    xScale={this.decideScaleFunction(scaleOnX)(dataSet,x,xMax)}
                    yScale={this.decideScaleFunction(scaleOnY)(dataSet,y,yMax)}
                    x={x}
                    y={y}
                    fill={"red"}
                  />  
